...
const OyuncuEkrani = ({navigation}) => {
  ...
  const getRandomName = () => {
    const names = ["Turşu", "Lastik", "Fıstık", "Limon", "Fırtına", "Seri Bıçak","Mantıklı","Şah Mat","Kedigöz","Ilık Su","Ürperti","Patates Fındık","Levye","Aşık","Optimus","Üstad","Salamcı","Simit","Deri Kapak","Cesur","Pilot","Sanrı","Dil","Kulak","Burun","Fazla","Az","Parşomen","Tohum"]; 
